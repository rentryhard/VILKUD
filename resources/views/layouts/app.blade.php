...
<nav class="navbar px-4 py-3" style="background-color: #5a3825;">
    <div class="d-flex align-items-center">
        <img src="{{ asset('images/vilkud.png') }}" alt="Logo" height="40" class="me-2">
        <a class="navbar-brand fw-bold text-white" href="{{ route('home') }}">Warkop Villa Kuda</a>
    </div>
    <div>
        ...
        <a href="{{ route('login') }}" class="btn btn-light ms-3">Login Mitra</a>
    </div>
</nav>
